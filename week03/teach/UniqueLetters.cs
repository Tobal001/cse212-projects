// Notes: "Testing for Membership" means checking whether a specific item 
//         is in a collection.
// Sets use the value to value determine the index
// Sets do not allow duplacates 
public static class UniqueLetters
{
    ...
    private static bool AreUniqueLetters(string text)
    {
        ...
        // Turn the string into a collection of unique characters 
        // if their is a duplicate char return false
